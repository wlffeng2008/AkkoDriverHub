...
MainWindow::MainWindow(QWidget *parent)
    ...
    connect(pCheck, &QTimer::timeout, this, [=] {
        ...
        if (last != toHide)
        {
            ...
            ui->labelInfo0->setHidden(toHide);
    ...
    ui->frameEmb->hide();
    ui->frameEmb->setStyleSheet("background-color: rgb(27, 27, 27); border-bottom-left-radius: 20px; border-bottom-right-radius:20px;");
...
void MainWindow::addDevice(quint32 id)
{
    ...
    if (dev)
    {
        ...
        {
            device->setFixedWidth(280);
            device->setImage( "./images/0002.png");
        }
...
bool MainWindow::eventFilter(QObject *obj, QEvent *e)
{
    ...
    if(e->type() != QEvent::Paint)
    {
        ...
        QPoint P1 = mapToGlobal(QPoint(20,420));
        QPoint P2 = mapToGlobal(QPoint(1210,420));
        m_pFloatLeft->setGeometry(P1.x(),P1.y(),48,48);
        m_pFloatRight->setGeometry(P2.x(),P2.y(),48,48);
